...
if(specChars === true){
  ...
  pass = pass.concat(specialChars[Math.floor((Math.random() * (33-0)+0))]);
  console.log(pass);
...
if(numChars === true){
  ...
  pass = pass.concat(numericalChars[Math.floor((Math.random() * (10-0)+0))]);
  console.log(pass);
  console.log(selectionsArray);
}
...
if(lowerChars === true){
  ...
  pass = pass.concat(lowercaseChars[Math.floor((Math.random() * (26-0)+0))]);
  console.log(pass);
  console.log(selectionsArray);
}
...
if(upperChars === true){
  ...
  pass = pass.concat(uppercaseChars[Math.floor((Math.random() * (26-0)+0))]);
  console.log(pass);
  console.log(selectionsArray);
}
